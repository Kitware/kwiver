...
{
  d->m_first = true;
  d->m_stream_reader = std::make_shared< kwiver::vital::data_stream_reader >(
    stream() );
}
...
::get_input()
{
  ...
  kwiver::vital::tokenize( line, m_input_buffer, m_delim,
...
::add_detection()
{
  ...
  m_current_set->add( std::make_shared< kwiver::vital::detected_object >( bbox,
                                                                          confid,
                                                                          dot ) );
