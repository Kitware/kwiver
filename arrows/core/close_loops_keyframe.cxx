...
::get_configuration() const
{
  ...
  algo::match_features::get_nested_algo_configuration( "feature_matcher",
                                                       config, d_->matcher );
...
::set_configuration( vital::config_block_sptr in_config )
{
  ...
  d_->min_keyframe_misses = config->get_value< unsigned int >(
    "min_keyframe_misses" );
          ...
          vital::image_container_sptr ) const
{
  ...
  d_->frame_matches[ frame_number ] =
    static_cast< unsigned int >( current_set->active_tracks( frames[ frames.
                                                                     size() -
                                                                     2 ] ).size() );
