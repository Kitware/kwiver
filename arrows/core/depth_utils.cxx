...
{
  std::vector< vector_3d > visible_landmarks = filter_visible_landmarks( cam,
                                                                         roi,
                                                                         landmarks );
  ...
  vector_3d const& world_normal )
{
  std::vector< vector_3d > visible_landmarks = filter_visible_landmarks( cam,
                                                                         roi,
                                                                         landmarks );
  compute_offset_range( visible_landmarks, world_normal, height_min,
                        height_max );
}
                    ...
                    double margin )
{
  ...
  unsigned int min_index =
    static_cast< unsigned int >( percentile * ( num_pts - 1 ) );
  unsigned int max_index =
    static_cast< unsigned int >( num_pts - 1 - min_index );
  unsigned int zmax_index =
    static_cast< unsigned int >( ( num_pts - 1 ) *
                                 ( 1.0 - zmax_percentile ) );
