...
::set_configuration( vital::config_block_sptr in_config )
{
  ...
  algo::detect_features::set_nested_algo_configuration( "feature_detector",
                                                        config, df );
  d_->detector = df;
  ...
  algo::feature_descriptor_io::set_nested_algo_configuration( "feature_io",
                                                              config, fi );
  d_->feature_io = fi;
  ...
  algo::close_loops::set_nested_algo_configuration( "loop_closer", config,
                                                    cl );
  d_->closer = cl;
}
...
::check_configuration( vital::config_block_sptr config ) const
{
  ...
  if( config->has_value( "loop_closer" ) &&
      ...
      !algo::close_loops::check_nested_algo_configuration( "loop_closer",
                                                           config ) )
  {
    config_valid = false;
  }
  ...
  return (
    algo::detect_features::check_nested_algo_configuration( "feature_detector",
                                                            config )
    &&
    algo::extract_descriptors::check_nested_algo_configuration(
      "descriptor_extractor", config )
    &&
    algo::match_features::check_nested_algo_configuration( "feature_matcher",
                                                           config )
    &&
    config_valid
    );
         ...
         image_container_sptr mask ) const
{
  ...
  if( prev_tracks )
  {
    ...
    {
      LOG_DEBUG( logger(),
                 "Using existing features on frame " << frame_number );
  ...
  {
    LOG_DEBUG( logger(),
               "Computing new descriptors on frame " << frame_number );
