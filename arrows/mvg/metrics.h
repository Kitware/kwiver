...
KWIVER_ALGO_MVG_EXPORT
std::vector< double >
reprojection_errors( const std::map< vital::frame_id_t,
                                     vital::camera_sptr >& cameras,
                     const std::map< vital::landmark_id_t,
                                     vital::landmark_sptr >& landmarks,
...
KWIVER_ALGO_MVG_EXPORT
double
reprojection_rmse( const std::map< vital::frame_id_t,
                                   vital::camera_sptr >& cameras,
                   const std::map< vital::landmark_id_t,
                                   vital::landmark_sptr >& landmarks,
                   const std::vector< vital::track_sptr >& tracks );
...
KWIVER_ALGO_MVG_EXPORT
double
reprojection_median_error( const std::map< vital::frame_id_t,
                                           vital::camera_sptr >& cameras,
                           const std::map< vital::landmark_id_t,
                                           vital::landmark_sptr >& landmarks,
                           const std::vector< vital::track_sptr >& tracks );
