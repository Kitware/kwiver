 ...
 *
 * The design here probably needs to be rethought. The canonical
 *implementations
...
{
  reader( kpf_canonical_io_adapter_base& b, int d ) : box_adapter( b ), domain(
                                                        d ) {}
...
{
  reader( kpf_canonical_io_adapter_base& b, int d ) : act_adapter( b ), domain(
                                                        d ) {}
...
reader( int& ts, int d ) : which( to_int ), int_ts( ts ),
                           unsigned_ts( u_dummy ), double_ts( d_dummy ),
                           domain( d ) {}
reader( unsigned& ts, int d ) : which( to_unsigned ), int_ts( i_dummy ),
                                unsigned_ts( ts ), double_ts( d_dummy ),
                                domain( d ) {}
reader( double& ts, int d ) : which( to_double ), int_ts( i_dummy ),
                              unsigned_ts( u_dummy ), double_ts( ts ), domain(
                                d ) {}
...
public:
  ...
  enum which_t { to_int, to_unsigned, to_double, };
reader( std::pair< int, int >& ts, int d ) : which( to_int ), int_ts( ts ),
                                             unsigned_ts( u_dummy ), double_ts(
                                               d_dummy ),  domain( d ) {}
...
reader( std::pair< double, double >& ts, int d ) : which( to_double ), int_ts(
                                                     i_dummy ), unsigned_ts(
                                                     u_dummy ),
                                                   double_ts( ts ), domain( d )
{
}
