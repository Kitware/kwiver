...
vpgl_perspective_camera< double >
crop_camera( const vpgl_perspective_camera< double >& camera, double left,
             double top )
{
  vpgl_perspective_camera< double > cam( camera );
  vpgl_calibration_matrix< double > K = cam.get_calibration();
...
void
depth_map_to_height_map( const vpgl_perspective_camera< double >& camera,
                         ...
                         vil_image_view< double >& height_map )
{
  ...
  const vnl_vector_fixed< double,
                          3 > v =
    vnl_inverse( P.extract( 3, 3 ) ).get_row( 2 );
...
void
height_map_to_depth_map( const vpgl_perspective_camera< double >& camera,
...
/// Convert a height map into a depth map
void
height_map_to_depth_map( vpgl_perspective_camera< double > const& camera,
