...
::detect( kwiver::vital::image_container_sptr image_data ) const
{
  ...
  {
    kwiver::vital::bounding_box_d bbox( detections->at< double >( i,
                                                                  (size_t) 0 ), //
                                                                                // tl-x
                                        detections->at< double >( i,
                                                                  (size_t) 1 ), //
                                                                                // tl-y
                                        detections->at< double >( i,
                                                                  (size_t) 2 ), //
    ...
    // Save mask in DOT
    auto detection = std::make_shared< kwiver::vital::detected_object >( bbox,
                                                                         detections->at< double >(
                                                                           i,
                                                                           4 ),
                                                                         dot );
