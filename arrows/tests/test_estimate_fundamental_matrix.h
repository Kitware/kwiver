...
TEST ( estimate_fundamental_matrix, ideal_points )
{
  ...
  auto cam1 =
    std::dynamic_pointer_cast< camera_perspective >( cams[ frame1 ] );
  auto cam2 =
    std::dynamic_pointer_cast< camera_perspective >( cams[ frame2 ] );
  ...
  fundamental_matrix_sptr true_F = fundamental_matrix_from_cameras( *cam1,
                                                                    *cam2 );
