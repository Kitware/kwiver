...
// -----------------------------------------------------------------------------
void
BuildCamera( kwiver::arrows::vtk::vtkKwiverCamera* out,
             ...
             kwiver::vital::camera_intrinsics_sptr const& ci )
{
  ...
  double const fov =
    vtkMath::DegreesFromRadians( 2.0 *
...
bool
vtkKwiverCamera
::ProjectPoint( kwiver::vital::vector_3d const& in,
                double ( & out )[ 2 ] )
{
  ...
  double pixel[ 2 ], double depth )
{
  ...
  auto const homogenousPoint =
    kwiver::vital::vector_3d{ normPoint[ 0 ] * depth,
                              normPoint[ 1 ] *
                              depth,
                              depth };
...
{
  auto const depth =
    this->KwiverCamera->depth( kwiver::vital::vector_3d( 0, 0, 0 ) );
...
::Update()
{
  ...
  // of the representation... that is, the depth (size) displayed for the
  // camera
