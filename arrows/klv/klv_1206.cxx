...
klv_1206_traits_lookup()
{
  static klv_tag_traits_lookup const lookup = {
    ...
    { { 0x060E2B3401010101, 0x0E0101033D000000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 90.0, 2 ),
      "Grazing Angle",
    ...
    { { 0x060E2B3401010101, 0x0E0101033D010000 },
      ...
      std::make_shared< klv_imap_format >( -90.0, 90.0, 2 ),
    ...
    { { 0x060E2B3401010101, 0x0E0101033D040000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 1.0e6, 4 ),
      "Range Resolution",
    ...
    { { 0x060E2B3401010101, 0x0E0101033D080000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 360.0, 2 ),
    ...
    { { 0x060E2B3401010101, 0x0E0101033D0E0000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 100.0, 2 ),
    ...
    { { 0x060E2B3401010101, 0x0E0101033D100000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 1.0, 2 ),
    ...
    { { 0x060E2B3401010101, 0x0E0101033D110000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 1.0e12, 4 ),
    ...
    { { 0x060E2B3401010101, 0x0E0101033D120000 },
      ...
      std::make_shared< klv_imap_format >( 0.0, 1.0e11, 4 ),
    ...
    { { 0x060E2B3402050101, 0x0E01030306000000 },
      ...
      std::make_shared<
        klv_1303_mdap_format<
          klv_lengthless_format< klv_imap_format > > >( 0.0, 1.0e6, 4 ),
