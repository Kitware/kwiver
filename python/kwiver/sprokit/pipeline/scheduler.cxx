...
PYBIND11_MODULE(scheduler, m)
{
  class_<sprokit::scheduler, scheduler_trampoline, sprokit::scheduler_t>(m, "PythonScheduler"
    ...
    .def(init<sprokit::pipeline_t, kwiver::vital::config_block_sptr>(), call_guard<pybind11::gil_scoped_release>())
    .def("start", &sprokit::scheduler::start, call_guard<pybind11::gil_scoped_release>()
      , "Start the execution of the pipeline.")
    .def("wait", &sprokit::scheduler::wait, call_guard<pybind11::gil_scoped_release>()
      , "Wait until the pipeline execution is complete.")
    .def("pause", &sprokit::scheduler::pause, call_guard<pybind11::gil_scoped_release>()
      , "Pause execution.")
    .def("resume", &sprokit::scheduler::resume, call_guard<pybind11::gil_scoped_release>()
      , "Resume execution.")
    .def("stop", &sprokit::scheduler::stop, call_guard<pybind11::gil_scoped_release>()
      , "Stop the execution of the pipeline.")
    .def("_start", static_cast<void (sprokit::scheduler::*)()>(&wrap_scheduler::_start), call_guard<pybind11::gil_scoped_release>()
      , "Implementation of starting the pipeline.")
    .def("_wait", static_cast<void (sprokit::scheduler::*)()>(&wrap_scheduler::_wait), call_guard<pybind11::gil_scoped_release>()
      , "Implementation of waiting until execution is complete.")
    .def("_pause", static_cast<void (sprokit::scheduler::*)()>(&wrap_scheduler::_pause), call_guard<pybind11::gil_scoped_release>()
      , "Implementation of pausing execution.")
    .def("_resume", static_cast<void (sprokit::scheduler::*)()>(&wrap_scheduler::_resume), call_guard<pybind11::gil_scoped_release>()
      , "Implementation of resuming execution.")
    .def("_stop", static_cast<void (sprokit::scheduler::*)()>(&wrap_scheduler::_stop), call_guard<pybind11::gil_scoped_release>()
      , "Implementation of stopping the pipeline.")
    .def("pipeline", static_cast<sprokit::pipeline_t (sprokit::scheduler::*)() const>(&wrap_scheduler::pipeline), call_guard<pybind11::gil_scoped_release>()
      , "Scheduler pipeline.")
