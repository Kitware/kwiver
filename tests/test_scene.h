...
cube_corners( double s,
              const kwiver::vital::vector_3d& c = kwiver::vital::vector_3d(
                0, 0, 0) )
{
  ...
  s /= 2.0;
  landmarks[ 0 ] =
    landmark_sptr( new landmark_d( c + vector_3d( -s, -s, -s ) ) );
  landmarks[ 1 ] =
    landmark_sptr( new landmark_d( c + vector_3d( -s, -s,  s ) ) );
  landmarks[ 2 ] =
    landmark_sptr( new landmark_d( c + vector_3d( -s,  s, -s ) ) );
...
cube_mesh( double s, const kwiver::vital::vector_3d& c = { 0.0, 0.0, 0.0 } )
{
  ...
  auto faces = new mesh_regular_face_array< 4 >{
    { 0, 1, 3, 2 },
    { 4, 6, 7, 5 },
    { 5, 7, 3, 1 },
    { 6, 4, 0, 2 },
    { 7, 6, 2, 3 },
    { 1, 0, 4, 5 } };
  return std::make_shared< mesh >( std::unique_ptr< mesh_vertex_array_base >(
                                     verts ),
            ...
            double degree_span = 115 )
{
  ...
  for( frame_id_t i = 0; i < num_cams; ++i )
  {
    ...
    simple_camera_perspective* cam =
      new simple_camera_perspective( scale * vector_3d( x, y, 2 + frac ), R,
                                     K );
    // look at the origin
...
init_cameras( kwiver::vital::frame_id_t num_cams = 20,
              kwiver::vital::simple_camera_intrinsics K =
              kwiver::vital::simple_camera_intrinsics(
                1000, kwiver::vital::vector_2d( 640, 480 ) ) )
{
               ...
               double pos_stdev = 1.0, double rot_stdev = 1.0 )
{
  ...
  {
    auto cam_ptr = std::dynamic_pointer_cast< vital::camera_perspective >(
      p.second );
    auto c = std::dynamic_pointer_cast< vital::camera_perspective >(
      cam_ptr->clone() );
...
subset_tracks( kwiver::vital::feature_track_set_sptr in_tracks,
...
kwiver::vital::feature_track_set_sptr
noisy_tracks( kwiver::vital::feature_track_set_sptr in_tracks,
              double stdev = 1.0 )
{
  using namespace kwiver::vital;
