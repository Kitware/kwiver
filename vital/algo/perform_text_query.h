...
/// @brief Abstract base class for text-based object detection and track refinement.
///
...
class VITAL_ALGO_EXPORT perform_text_query
  : public algorithm_def< perform_text_query >
{
public:
  /// Return the name of this algorithm
  static std::string static_type_name() { return "perform_text_query"; }
  ...
  ///
  /// \param images Vector of images to process. Interpretation depends on context:
  ...
  perform_query(
    ...
    std::vector< object_track_set_sptr > const& input_tracks = {}
  ) const = 0;
