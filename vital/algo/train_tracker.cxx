...
::add_data_from_disk(
  ...
  VITAL_UNUSED std::vector< kwiver::vital::object_track_set_sptr > train_groundtruth,
  VITAL_UNUSED std::vector< std::string > test_image_names,
  VITAL_UNUSED std::vector< kwiver::vital::object_track_set_sptr > test_groundtruth )
{
...
INSTANTIATE_ALGORITHM_DEF( kwiver::vital::algo::train_tracker );
/// \endcond
