...
{
  config_path_t fp( "/this/shouldnt/exist/anywhere" );
...
{
  config_path_t fp = ST::GetCurrentWorkingDirectory();
...
TEST_F ( config_block_io, successful_config_read )
{
  config_block_sptr config = kwiver::vital::read_config_file(
    data_dir + "/test_config-valid_file.txt" );
...
{
  config_block_sptr config = kwiver::vital::read_config_file(
    data_dir + "/test_config-include-a.txt" );
...
TEST_F ( config_block_io, include_files_failure )
{
  ...
  EXPECT_THROW(
    kwiver::vital::read_config_file( data_dir +
                                     "/test_config-include_files_in_path.txt" ),
...
TEST_F ( config_block_io, invalid_config_file )
{
  EXPECT_THROW(
    kwiver::vital::read_config_file(
      data_dir + "/test_config-invalid_file.txt" ),
...
TEST_F ( config_block_io, invalid_keypath )
{
  EXPECT_THROW(
    kwiver::vital::read_config_file( data_dir +
                                     "/test_config-invalid_keypath.txt" ),
    kwiver::vital::config_file_not_parsed_exception )
...
{
  config_block_sptr config = kwiver::vital::read_config_file(
    data_dir + "/test_config-comments.txt" );
...
TEST_F ( config_block_io, write_config_simple_success )
{
  ...
  config_block_description_t descrD = config_block_description_t(
    "Test descr 1" );
