...
create_type_trait( camera_perspective, "kwiver:camera_perspective", kwiver::vital::camera_perspective_sptr );
...
create_type_trait( local_geo_cs, "kwiver:local_geo_cs", kwiver::vital::local_geo_cs );
...
create_type_trait( metadata_map, "kwiver:metadata_map", kwiver::vital::metadata_map_sptr );
create_type_trait( object_track_set, "kwiver:object_track_set", kwiver::vital::object_track_set_sptr );
create_type_trait( pointcloud, "kwiver:pointcloud", kwiver::vital::pointcloud_sptr );
...
create_type_trait( video_raw_metadata, "kwiver:video_raw_metadata", kwiver::vital::video_raw_metadata_sptr );
create_type_trait( video_settings, "kwiver:video_settings", kwiver::vital::video_settings_sptr );
create_type_trait( video_uid, "kwiver:video_uuid", kwiver::vital::uid );
create_type_trait( video_uninterpreted_data, "kwiver:video_uninterpreted_data", kwiver::vital::video_uninterpreted_data_sptr );
...
create_port_trait( camera_perspective, camera_perspective, "Perspective camera." );
...
create_port_trait( local_geo_cs, local_geo_cs, "Local geographic coordinate system." );
...
create_port_trait( metadata_map, metadata_map, "Map of metadata indexed by frame." );
...
create_port_trait( video_raw_image, video_raw_image, "Raw video image data for efficient transcoding." );
create_port_trait( video_raw_metadata, video_raw_metadata, "Raw video metadata for efficient transcoding." );
...
create_port_trait( video_uninterpreted_data, video_uninterpreted_data, "Uninterpreted video data." );
